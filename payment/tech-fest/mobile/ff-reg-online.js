...
<body>
    <div class="container">
        <form method="post" name="groupEventForm" enctype="multipart/form-data" action="https://script.google.com/macros/s/AKfycbzuoY-4tTcPIr1osPvVw6v2NUcnycdsBFOsrkTW4ipGRtj1MnMe07V24KKZLeZcNqHrPg/exec" aria-label="Group Events Registration Form">
    ...
    <script src="grp-reg-online.js"></script>
</body>
</html>
